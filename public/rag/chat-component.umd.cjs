...
(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports) : typeof define === "function" && define.amd ? define(["exports"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global["chat-component"] = {}));
  ...
  const r$2 = (t2) => new o$6("string" == typeof t2 ? t2 : t2 + "", void 0, s$3), i$4 = (t2, ...e2) => {
    ...
    e$6 ? s2.adoptedStyleSheets = n2.map((t2) => t2 instanceof CSSStyleSheet ? t2 : t2.styleSheet) : n2.forEach((e2) => {
      const n3 = document.createElement("style"), o2 = t$4.litNonce;
   ...
   */
  var t$3;
  const i$3 = window, s$1 = i$3.trustedTypes, e$4 = s$1 ? s$1.createPolicy("lit-html", { createHTML: (t2) => t2 }) : void 0, o$4 = "$lit$", n$3 = `lit$${(Math.random() + "").slice(9)}$`, l$1 = "?" + n$3, h = `<${l$1}>`, r = document, u = () => r.createComment(""), d = (t2) => null === t2 || "object" != typeof t2 && "function" != typeof t2, c = Array.isArray, v = (t2) => c(t2) || "function" == typeof (null == t2 ? void 0 : t2[Symbol.iterator]), a = "[ 	\n\f\r]", f = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, _ = /-->/g, m = />/g, p = RegExp(`>|${a}(?:([^\\s"'>=/]+)(${a}*=${a}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), g = /'/g, $ = /"/g, y = /^(?:script|style|textarea|title)$/i, w = (t2) => (i2, ...s2) => ({ _$litType$: t2, strings: i2, values: s2 }), x = w(1), T = Symbol.for("lit-noChange"), A = Symbol.for("lit-nothing"), E = /* @__PURE__ */ new WeakMap(), C = r.createTreeWalker(r, 129, null, false);
  ...
  const V = (t2, i2) => {
    ...
    for (let i3 = 0; i3 < s2; i3++) {
      ...
      r2 += u2 === f ? s3 + h : v2 >= 0 ? (e2.push(d2), s3.slice(0, v2) + o$4 + s3.slice(v2) + n$3 + w2) : s3 + n$3 + (-2 === v2 ? (e2.push(void 0), i3) : w2);
    }
  ...
  function n$1(n2) {
    return (t2, o2) => void 0 !== o2 ? e$2(n2, t2, o2) : i$2(n2, t2);
  }
  /**
   * @license
   * Copyright 2017 Google LLC
   ...
   * SPDX-License-Identifier: BSD-3-Clause
   */
  const o$2 = ({ finisher: e2, descriptor: t2 }) => (o2, n2) => {
    var r2;
    if (void 0 === n2) {
...
`;
  ...
  exports2.TeaserListComponent = class TeaserListComponent extends s {
    constructor() {
      super(...arguments);
      this.teasers = [];
      this.heading = void 0;
  ...
  exports2.TeaserListComponent.styles = [styles$8];
  __decorateClass$a([
    n$1({ type: Array })
  ], exports2.TeaserListComponent.prototype, "teasers", 2);
  __decorateClass$a([
    n$1({ type: String })
  ], exports2.TeaserListComponent.prototype, "heading", 2);
  __decorateClass$a([
    n$1({ type: String })
  ], exports2.TeaserListComponent.prototype, "actionLabel", 2);
  __decorateClass$a([
    n$1({ type: Boolean })
  ], exports2.TeaserListComponent.prototype, "alwaysRow", 2);
  __decorateClass$a([
    n$1({ type: Boolean })
  ], exports2.TeaserListComponent.prototype, "clickable", 2);
  exports2.TeaserListComponent = __decorateClass$a([
    e$3("teaser-list-component")
  ], exports2.TeaserListComponent);
  const styles$7 = i$4`
  .tab-component__list {
    list-style-type: none;
    display: flex;
...
`;
  ...
  exports2.TabComponent = class TabComponent extends s {
    constructor() {
      super(...arguments);
      this.tabs = [];
  ...
  exports2.TabComponent.styles = [styles$7];
  __decorateClass$9([
    n$1({ type: Array })
  ], exports2.TabComponent.prototype, "tabs", 2);
  __decorateClass$9([
    n$1({ type: String })
  ], exports2.TabComponent.prototype, "selectedTabId", 2);
  exports2.TabComponent = __decorateClass$9([
    e$3("tab-component")
  ], exports2.TabComponent);
...
`;
  ...
  exports2.LoadingIndicatorComponent = class LoadingIndicatorComponent extends s {
    constructor() {
      super(...arguments);
      this.label = "";
    }
    render() {
      ...
      <p data-testid="loading-indicator" aria-label="${this.label}">
        <span>${o(iconSpinner)}</span>
        <span>${this.label}</span>
      </p>
    `;
    }
  };
  exports2.LoadingIndicatorComponent.styles = [styles$4];
  __decorateClass$6([
    n$1({ type: String })
  ], exports2.LoadingIndicatorComponent.prototype, "label", 2);
  exports2.LoadingIndicatorComponent = __decorateClass$6([
    e$3("loading-indicator")
  ], exports2.LoadingIndicatorComponent);
  const styles$3 = i$4`
  button {
    color: var(--text-color);
    font-weight: bold;
...
`;
  ...
  exports2.VoiceInputButton = class VoiceInputButton extends s {
    constructor() {
      super(...arguments);
    ...
    renderVoiceButton() {
      ...
      >
        ${this.enableVoiceListening ? o(iconMicOn) : o(iconMicOff)}
      </button>
    `;
    }
    render() {
  ...
  exports2.VoiceInputButton.styles = [styles$3];
  __decorateClass$5([
    t$2()
  ], exports2.VoiceInputButton.prototype, "showVoiceInput", 2);
  __decorateClass$5([
    t$2()
  ], exports2.VoiceInputButton.prototype, "enableVoiceListening", 2);
  exports2.VoiceInputButton = __decorateClass$5([
    e$3("voice-input-button")
  ], exports2.VoiceInputButton);
...
`;
  ...
  exports2.DocumentPreviewerComponent = class DocumentPreviewerComponent extends s {
    constructor() {
      super(...arguments);
      this.url = void 0;
  ...
  __decorateClass$4([
    n$1({ type: String })
  ], exports2.DocumentPreviewerComponent.prototype, "url", 2);
  __decorateClass$4([
    t$2()
  ], exports2.DocumentPreviewerComponent.prototype, "previewContent", 2);
  __decorateClass$4([
    t$2()
  ], exports2.DocumentPreviewerComponent.prototype, "loading", 2);
  exports2.DocumentPreviewerComponent = __decorateClass$4([
    e$3("document-previewer")
  ], exports2.DocumentPreviewerComponent);
  const styles$2 = i$4`
  .subheadline--small {
    font-size: 12px;
...
`;
  ...
  exports2.CitationListComponent = class CitationListComponent extends s {
    constructor() {
      super(...arguments);
      this.label = void 0;
  ...
  exports2.CitationListComponent.styles = [styles$2];
  __decorateClass$3([
    n$1({ type: String })
  ], exports2.CitationListComponent.prototype, "label", 2);
  __decorateClass$3([
    n$1({ type: Array })
  ], exports2.CitationListComponent.prototype, "citations", 2);
  __decorateClass$3([
    n$1({ type: Object })
  ], exports2.CitationListComponent.prototype, "selectedCitation", 2);
  exports2.CitationListComponent = __decorateClass$3([
    e$3("citation-list")
  ], exports2.CitationListComponent);
  const styles$1 = i$4`
  ul {
    margin-block-start: 0;
    margin-block-end: 0;
...
`;
  ...
  exports2.ChatActionButtonComponent = class ChatActionButtonComponent extends s {
    constructor() {
      super(...arguments);
      this.label = "";
      this.svgIcon = "";
  ...
  exports2.ChatActionButtonComponent.styles = [styles];
  __decorateClass$2([
    n$1({ type: String })
  ], exports2.ChatActionButtonComponent.prototype, "label", 2);
  __decorateClass$2([
    n$1({ type: String })
  ], exports2.ChatActionButtonComponent.prototype, "svgIcon", 2);
  __decorateClass$2([
    n$1({ type: Boolean })
  ], exports2.ChatActionButtonComponent.prototype, "isDisabled", 2);
  __decorateClass$2([
    n$1({ type: String })
  ], exports2.ChatActionButtonComponent.prototype, "actionId", 2);
  __decorateClass$2([
    n$1({ type: String })
  ], exports2.ChatActionButtonComponent.prototype, "tooltip", 2);
  exports2.ChatActionButtonComponent = __decorateClass$2([
    e$3("chat-action-button")
  ], exports2.ChatActionButtonComponent);
  ...
  exports2.ChatThreadComponent = class ChatThreadComponent extends s {
    constructor() {
      super(...arguments);
      this.chatThread = [];
      this.actionButtons = [];
  ...
  exports2.ChatThreadComponent.styles = [styles$1];
  __decorateClass$1([
    n$1({ type: Array })
  ], exports2.ChatThreadComponent.prototype, "chatThread", 2);
  __decorateClass$1([
    n$1({ type: Array })
  ], exports2.ChatThreadComponent.prototype, "actionButtons", 2);
  __decorateClass$1([
    n$1({ type: Boolean })
  ], exports2.ChatThreadComponent.prototype, "isDisabled", 2);
  __decorateClass$1([
    n$1({ type: Boolean })
  ], exports2.ChatThreadComponent.prototype, "isProcessingResponse", 2);
  __decorateClass$1([
    t$2()
  ], exports2.ChatThreadComponent.prototype, "isResponseCopied", 2);
  __decorateClass$1([
    i$1("#chat-list-footer")
  ], exports2.ChatThreadComponent.prototype, "chatFooter", 2);
  __decorateClass$1([
    n$1({ type: Object })
  ], exports2.ChatThreadComponent.prototype, "selectedCitation", 2);
  exports2.ChatThreadComponent = __decorateClass$1([
    e$3("chat-thread-component")
  ], exports2.ChatThreadComponent);
  ...
  exports2.ChatComponent = class ChatComponent extends s {
    constructor() {
      super(...arguments);
      ...
      this.threadComponent = new exports2.ChatThreadComponent();
      this.isDisabled = false;
  ...
  ], exports2.ChatComponent.prototype, "isLocalStorageEnabled", 2);
  __decorateClass([
    n$1({
      type: String,
  ...
  ], exports2.ChatComponent.prototype, "isChatScrollEnabled", 2);
  __decorateClass([
    n$1({ type: String })
  ], exports2.ChatComponent.prototype, "currentQuestion", 2);
  __decorateClass([
    i$1("#question-input")
  ], exports2.ChatComponent.prototype, "questionInput", 2);
  __decorateClass([
    t$2()
  ], exports2.ChatComponent.prototype, "isDisabled", 2);
  __decorateClass([
    t$2()
  ], exports2.ChatComponent.prototype, "isChatStarted", 2);
  __decorateClass([
    t$2()
  ], exports2.ChatComponent.prototype, "isResetInput", 2);
  __decorateClass([
    t$2()
  ], exports2.ChatComponent.prototype, "isShowingThoughtProcess", 2);
  __decorateClass([
    t$2()
  ], exports2.ChatComponent.prototype, "isDefaultPromptsEnabled", 2);
  __decorateClass([
    t$2()
  ], exports2.ChatComponent.prototype, "selectedCitation", 2);
  __decorateClass([
    t$2()
  ], exports2.ChatComponent.prototype, "selectedChatEntry", 2);
  exports2.ChatComponent = __decorateClass([
    e$3("chat-component")
  ], exports2.ChatComponent);
  exports2.ChatResponseError = ChatResponseError;
  exports2.callHttpApi = callHttpApi;
  exports2.cancelStream = cancelStream;
  exports2.chatEntryToString = chatEntryToString;
  exports2.cleanUpFollowUp = cleanUpFollowUp;
  exports2.createReader = createReader;
  exports2.getAPIResponse = getAPIResponse;
  exports2.getTimestamp = getTimestamp;
  exports2.newListWithEntryAtIndex = newListWithEntryAtIndex;
  exports2.parseCitations = parseCitations;
  exports2.parseStreamedMessages = parseStreamedMessages;
  exports2.processText = processText;
  exports2.readStream = readStream;
  exports2.updateCitationsEntry = updateCitationsEntry;
  exports2.updateFollowingStepOrFollowupQuestionEntry = updateFollowingStepOrFollowupQuestionEntry;
  exports2.updateTextEntry = updateTextEntry;
